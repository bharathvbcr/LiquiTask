...
ipcMain$1.handle("storage:get", (_event, key) => store.get(key));
ipcMain$1.handle("storage:set", (_event, key, value) => store.set(key, value));
ipcMain$1.handle("storage:delete", (_event, key) => store.delete(key));
ipcMain$1.handle("storage:clear", () => store.clear());
ipcMain$1.handle("storage:has", (_event, key) => store.has(key));
let mainWindow = null;
...
ipcMain$1.handle("window:minimize", () => mainWindow?.minimize());
ipcMain$1.handle("window:maximize", () => {
