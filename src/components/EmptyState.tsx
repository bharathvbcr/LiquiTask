  ...
  if (type === "projects") {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-900/30 to-red-800/30 flex items-center justify-center mb-6 border border-red-500/20 shadow-lg shadow-red-500/10">
          <FolderPlus size={36} className="text-red-400" />
        </div>
        ...
        {onCreateProject && (
          <LiquidButton label="Create Workspace" onClick={onCreateProject} icon={<Plus size={18} className="text-red-100" />} />
        )}
      </div>
    );
  }
