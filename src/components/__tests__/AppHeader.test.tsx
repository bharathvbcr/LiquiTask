...
vi.mock('./SearchHistoryDropdown', () => ({ default: () => <div>Search History</div> }));
vi.mock('./SavedViewControls', () => ({ default: () => <div>Saved Views</div> }));
vi.mock('./FilterBuilder', () => ({ default: () => <div>Filter Builder</div> }));
...
describe('AppHeader', () => {
    ...
    const baseProps = {
        ...
        filters: { assignee: '', tags: '', dateRange: '', startDate: '', endDate: '' } as any,
