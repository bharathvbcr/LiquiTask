...
export const AutomationRuleEditor: React.FC<AutomationRuleEditorProps> = ({
  ...
  const [conditions, setConditions] = useState<FilterGroup>(
    rule?.conditions || { id: "root", operator: "AND", rules: [] },
  );
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-black/20 border border-white/10 rounded-lg p-4">
              <FilterBuilder rootGroup={conditions} onChange={setConditions} customFields={[]} />
            </div>
          </div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleUpdateAction(index, {
                          type: e.target.value as AutomationAction,
                        })
                      }
