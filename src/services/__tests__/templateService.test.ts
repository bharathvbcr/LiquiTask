...
describe('TemplateService', () => {
    ...
    it('should load and get templates', () => {
        const templates: TaskTemplate[] = [
            { id: 't1', name: 'T1', taskData: {}, variables: [], tags: [], subtasks: [], customFieldValues: {} }
        ];
    ...
    it('should throw error when template not found', () => {
        expect(() => service.createFromTemplate('non-existent')).toThrow('Template non-existent not found');
    });
