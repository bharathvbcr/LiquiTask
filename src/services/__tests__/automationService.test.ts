...
import { AutomationService, AutomationRule } from '../automationService';
...
describe('AutomationService', () => {
    ...
    it('should evaluate conditions correctly', () => {
        const rule: AutomationRule = {
            ...
            conditions: {
                ...
                type: 'AND',
                rules: [
                    { id: 'c1', field: 'status', operator: 'equals', value: 'Todo' }
                ]
            },
        ...
        const updates2 = service.processTaskEvent('onUpdate', { newTask: nonMatchingTask }, [nonMatchingTask]);
    ...
    it('should handle notify action', () => {
        ...
        service.processTaskEvent('onUpdate', { newTask: mockTask }, [mockTask], { onNotify });
    ...
    it('should handle scheduled rules', async () => {
        ...
        expect(applyTaskUpdates).toHaveBeenCalledWith(mockTask.id, expect.objectContaining({
