...
export const TaskSchema: z.ZodType<Task> = z
  .object({
    ...
    timeSpent: z.number().min(0).max(100000).default(0),
...
export const ProjectTypeSchema: z.ZodType<ProjectType> = z
  .object({
    id: z.string().trim(),
...
export const PriorityDefinitionSchema: z.ZodType<PriorityDefinition> = z
  .object({
    id: z.string().trim(),
    label: z.string().trim().min(1, "Label is required"),
    color: z
...
export const CustomFieldDefinitionSchema: z.ZodType<CustomFieldDefinition> = z
  .object({
    id: z.string().trim(),
    label: z.string().trim().min(1, "Label is required"),
