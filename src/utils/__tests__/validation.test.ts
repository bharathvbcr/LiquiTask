...
describe("validation schemas", () => {
  ...
  describe("TaskSchema", () => {
    ...
    it("should validate task with optional fields", () => {
      const taskWithOptional = {
        ...
        updatedAt: new Date(),
        dueDate: new Date(),
        subtasks: [{ id: "sub-1", title: "Subtask", completed: false }],
        attachments: [],
  ...
  describe("AppDataSchema", () => {
    it("should validate complete app data", () => {
      const appData = {
        columns: [{ id: "col-1", title: "Column", color: "#ff0000" }],
        projects: [{ id: "p1", name: "Project", type: "folder" }],
        tasks: [],
        priorities: [{ id: "high", label: "High", color: "#ff0000", level: 1 }],
        projectTypes: [{ id: "type-1", label: "Type", icon: "folder" }],
        customFields: [],
        activeProjectId: "p1",
