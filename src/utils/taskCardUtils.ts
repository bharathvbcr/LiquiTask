...
import { AlertCircle, Clock, ArrowDown, ArrowUp, Zap, Star, Shield, Flame, AlertTriangle, Flag, Minus } from 'lucide-react';
...
export const getPriorityIcon = (iconName?: string, size = 12) => {
  switch (iconName) {
    case 'alert-circle': return React.createElement(AlertCircle, { size });
    case 'clock': return React.createElement(Clock, { size });
    case 'arrow-down': return React.createElement(ArrowDown, { size });
    case 'arrow-up': return React.createElement(ArrowUp, { size });
    case 'zap': return React.createElement(Zap, { size });
    case 'star': return React.createElement(Star, { size });
    case 'shield': return React.createElement(Shield, { size });
    case 'flame': return React.createElement(Flame, { size });
    case 'alert-triangle': return React.createElement(AlertTriangle, { size });
    case 'flag': return React.createElement(Flag, { size });
    case 'minus': return React.createElement(Minus, { size });
    default: return null;
  }
};
