...
describe('Dashboard', () => {
    const mockTasks: Task[] = [
        { id: '1', title: 'High Task', priority: 'high', status: 'Todo', projectId: 'p1', createdAt: new Date() } as Task,
        { id: '2', title: 'Soon Task', priority: 'medium', status: 'Todo', projectId: 'p1', dueDate: new Date(Date.now() + 86400000), createdAt: new Date() } as Task,
        { id: '3', title: 'Normal Task', priority: 'low', status: 'Todo', projectId: 'p1', createdAt: new Date() } as Task,
    ];
